    ...
    return (
        <>
            ...
            <div className={"pure-g"}>
                <button className={"pure-u-1-5 pure-u-sm-1-12 pure-u-lg-1-24 pure-button"}
            ...
            <div className={"pure-g"}>
                ...
                <button className={"pure-u-1-5 pure-u-sm-1-12 pure-u-lg-1-24 pure-button pure-button-primary"}
                        onClick={() => calculate()}> =
                </button>
            </div>
            <Result value={result}/>
